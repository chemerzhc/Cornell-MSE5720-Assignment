...
results_folder=$SCRATCH/cto_vc_relax #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/results/Q4 #MODIFY FOR EACH JOB #Name of folder when job is completed
...
PREFIX="CTO_vc_PBE"
PSEUDO_DIR="/scratch/11018/zhc/assisgnment1/CaTiO3/"
INFILE="$PREFIX.in"
OUTFILE="$PREFIX.out"
