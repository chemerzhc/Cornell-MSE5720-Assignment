...
results_folder=$SCRATCH/diamond_100 #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/Diamond_energyoff #MODIFY FOR EACH JOB #Name of folder when job is completed
