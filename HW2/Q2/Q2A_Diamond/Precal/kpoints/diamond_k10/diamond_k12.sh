...
results_folder=$SCRATCH/diamond_k12 #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/Diamond_20251020 #MODIFY FOR EACH JOB #Name of folder when job is completed
