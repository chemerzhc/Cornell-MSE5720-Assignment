...
results_folder=$SCRATCH/20251018 #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/Q1D_energyoff #MODIFY FOR EACH JOB #Name of folder when job is completed
mkdir $results_folder
work_results_folder=$WORK/CaTiO3 #MODIFY FOR EACH JOB #Folder in $WORK where results are saved
...
PREFIX="BTO"
PSEUDO_DIR="/scratch/11018/zhc/Assisgnment2/Q1/1D/energy_off/"
INFILE="$PREFIX.in"
OUTFILE="$PREFIX.out"
...
/
ATOMIC_SPECIES
 Ba 137.327d0 Ba_LDA.UPF 
 Ti 47.88d0 Ti_LDA.UPF
 O  16.00d0 O_LDA.UPF

ATOMIC_POSITIONS crystal
 Ba 0.d0 0.d0 0.d0
 Ti 0.5d0 0.5d0 0.5d0
 O 0.5d0 0.5d0 0.d0
 O 0.5d0 0.d0 0.5d0
 O 0.d0 0.5d0 0.5d0
