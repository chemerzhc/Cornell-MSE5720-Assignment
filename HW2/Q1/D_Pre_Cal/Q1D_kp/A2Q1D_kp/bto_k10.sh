...
results_folder=$SCRATCH/bto_k10 #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/A2Q1D_kp #MODIFY FOR EACH JOB #Name of folder when job is completed
...
PREFIX="BTO_k10"
PSEUDO_DIR="/scratch/11018/zhc/Assisgnment2/Q1/1D/Kpoints/"
INFILE="$PREFIX.in"
OUTFILE="$PREFIX.out"
