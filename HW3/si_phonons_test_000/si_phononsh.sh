...
results_folder=$SCRATCH/si_phonons_test_000 #MODIFY FOR EACH JOB
results_folder_final_name=$SCRATCH/si_phonons_results_000#MODIFY FOR EACH JOB #Name of folder when job is completed
